...
- `09-CONNECT-EXPRESS-SCOPE.md` — Stripe Connect Express plan (self-serve per-performer payouts, the 10% platform fee) — **built and confirmed working end-to-end on staging 2026-09-10**, production port still open
